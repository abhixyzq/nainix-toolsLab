      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass p-8 rounded-3xl mb-16 border border-purple-500/20 shadow-2xl relative overflow-hidden">
            ...
            <div className="text-center mb-8 relative z-10">
                <div className="inline-block p-3 rounded-2xl bg-purple-100 dark:bg-purple-900/30 text-4xl mb-4">🔑</div>
            ...
            <div className="relative z-10">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <button onClick={generatePassword} className="bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-xl font-bold shadow-lg transition-all">Generate New ⚡</button>
                    <button onClick={() => {navigator.clipboard.writeText(password); setCopied(true)}} className={`border ${copied ? 'bg-green-500 text-white border-green-500' : 'border-purple-500 text-purple-600 dark:text-purple-300'} py-3 rounded-xl font-bold transition-all`}>
